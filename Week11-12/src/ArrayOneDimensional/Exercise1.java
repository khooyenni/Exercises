...
public class Exercise1 {
	...
	public static void main(String[] args) {
		...
		//output the value of 10th elements of the array alpha
		...
		//set the value of the ninth element of the array alpha to sum of the sixth and thirteen element of the array alpha
